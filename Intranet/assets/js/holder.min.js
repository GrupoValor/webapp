...
function(a, b) {
    ...
    return function(a) {
        ...
        (function(b) {
            ...
            function e(a, b) {
                var c = {
                    ...
                    d = a.indexOf("?"),
                    e = [a]; - 1 !== d && (e = [a.slice(0, d), a.slice(d + 1)]);
                var f = e[0].split("/");
                c.holderURL = a;
                var g = f[1],
                    h = g.match(/([\d]+p?)x([\d]+p?)/);
            ...
            function f(a) {
                ...
                var q = d.holderURL,
                    r = A(e, null);
                if (d.font && (h.font = d.font, !r.noFontFallback && "img" === c.nodeName.toLowerCase() && E.setup.supportsCanvas && "svg" === r.renderer && (r = A(r, {
                        renderer: "canvas"
                    }))), d.font && "canvas" == r.renderer && (r.reRender = !0), "background" == b) null == c.getAttribute("data-background-src") && v.setAttr(c, {
                    "data-background-src": q
                });
                else {
                    var s = {};
            ...
            function h(a) {
                ...
                if (q.lineCount > 1) {
                    ...
                    if (b(p, t, v, p.properties.leading), p.add(t), "left" === a.align) p.moveTo(a.width - e, null, null);
            ...
            var q = c(2),
                ...
                D = {
                    ...
                    run: function(a) {
                        ...
                        return c.stylesheets = [], c.svgXMLStylesheet = !0, c.noFontFallback = g.noFontFallback ? g.noFontFallback : !1, j.forEach(function(a) {
                ...
                F = function() {
                    ...
                    return function(d) {
                        ...
                        if (E.setup.supportsSVG) {
                            ...
                            null != a && a.parentNode === document.body || (f = !0), a = u.initSVG(a, e.properties.width, e.properties.height), a.style.display = "block", f && (b = v.newEl("text", C), c = g(null), v.setAttr(b, {
                                x: 0
        ...
        (function(a, d) {
            ...
            function g(b, c) {
                if (b = p(b, 0 > c ? 0 : 0 | q(c)), !a.TYPED_ARRAY_SUPPORT)
                    for (var d = 0; c > d; d++) b[d] = 0;
                return b
            }
            ...
            a.TYPED_ARRAY_SUPPORT = void 0 !== d.TYPED_ARRAY_SUPPORT ? d.TYPED_ARRAY_SUPPORT : e(), a.TYPED_ARRAY_SUPPORT && (a.prototype.__proto__ = Uint8Array.prototype, a.__proto__ = Uint8Array), a.isBuffer = function(a) {
                ...
                return this === b ? !0 : 0 === a.compare(this, b)
            ...
            a.prototype.slice = function(b, c) {
                ...
                var e;
                if (a.TYPED_ARRAY_SUPPORT) e = a._augment(this.subarray(b, c));
                else {
                    var f = c - b;
                    e = new a(f, void 0);
                ...
                var f, g = e - d;
                if (this === b && c > d && e > c)
                    for (f = g - 1; f >= 0; f--) b[f + c] = this[f + d];
                else if (1e3 > g || !a.TYPED_ARRAY_SUPPORT)
                    for (f = 0; g > f; f++) b[f + c] = this[f + d];
                else b._set(this.subarray(d, d + g), c);
                return g
        ...
        c.rgb2hex = function(a, b, c) {
            ...
            var b = Math.min(1, Math.max(0, Math.abs(a))) * (0 > a ? -1 : 1),
                d = 255 * b | 0,
        ...
        a.exports = function d(a, b, c) {
            ...
            var i, j, k, l, m = 1,
                n = !0;
            if (c = c || {}, "string" == typeof a[0]) a[0] = e(a[0]);
            else {
            ...
            for (; m < a.length; m++) {
                ...
                if (void 0 !== a[m] && a[m] !== !0)
                    if ("string" == typeof a[m]) n && (a[m] = h(a[m])), a[0].children.push(a[m]);
                    else if ("number" == typeof a[m]) a[0].children.push(a[m]);
                else if (Array.isArray(a[m])) {
                ...
                } else if ("function" == typeof a[m]) k = a[m];
                else {
