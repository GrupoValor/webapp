...
! function(a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
            ...
            if (!this.grid) {
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"],
                    ...
                    F = function(a) {
                        var b, c, e = [],
                            f = 0;
                        for (c = 0; c < d.p.colModel.length; c++) b = d.p.colModel[c], "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (e[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name,
                            d.p.keyName !== !1 && b.key === !0 && (d.p.keyName = e[f]), f++);
                        return e
                    },
                    G = function(a) {
                    ...
                    M = function(a, b, c, e) {
                        ...
                        if (a) {
                            ...
                            for (d.p.grouping && (aa = d.p.groupingView.groupCollapse === !0, Y = $.jgrid.getMethod("groupingPrepare")); t > o;) {
                                ...
                                var fa = Q.length;
                                for (Q.push(""), M && Q.push(E(0, o, d.p.page, d.p.rowNum, ca)), J && Q.push(D(x, M, o, U, da)), L && Q.push(r.call(A, J + M, o + b)), s = O, g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = N)), p = 0; p < s.length; p++) m = $.jgrid.getAccessor(q, s[p]), P[d.p.colModel[p + J + L + M].name] = m, Q.push(C(x, m, p + J + L + M, o + b, q, P));
                                if (z += U ? " " + n : "", Q[fa] = K(x, aa, z, P, q), Q.push("</tr>"), d.p.grouping && (_.push(Q), d.p.groupingView._locgr || Y.call(A, P, o), Q = []), (j || d.p.treeGrid === !0 && !d.p._ald) && (P[i] = $.jgrid.stripPref(d.p.idPrefix, x), d.p.data.push(P), d.p._index[P[i]] = d.p.data.length - 1), d.p.gridview === !1 && (ba.append(Q.join("")), A.triggerHandler("jqGridAfterInsertRow", [x, P, q]), Z && d.p.afterInsertRow.call(d, x, P, q), Q = []), P = {}, B++, o++, B === V) break
                            }
                            if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (ba.append(Q.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === !0) try {
                        ...
                        if ($.isArray(d.p.data)) {
                            ...
                            if ($.each(d.p.colModel, function() {
                                    if (c = this.sorttype || "text", o = this.index || this.name, "date" === c || "datetime" === c ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? (b = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(d, "formatter.date.srcformat"), e = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(d, "formatter.date.newformat")) : b = e = this.datefmt || "Y-m-d", j[o] = {
                                        ...
                                        for (n = 0, m = p.groupField.length; m > n; n++) this.name === p.groupField[n] && (k[n] = j[o], l[n] = o);
                            ...
                            if (d.p.ignoreCase && (r = r.ignoreCase()), d.p.search === !0) {
                                ...
                                if (u) "string" == typeof u && (u = $.jgrid.parse(u)), a(u);
                                else try {
                            ...
                            if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (m = 0, g = null), d.p.grouping)
                                for (n = 0; m > n; n++) r.orderBy(l[n], p.groupOrder[n], k[n].stype, k[n].srcfmt);
                            ...
                            if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
                                ...
                                for (C = 0; y > C; C++) {
                                    if (E)
                                        for (D in d.p.userData) d.p.userData.hasOwnProperty(D) && (d.p.userData[D] += parseFloat(w[C][D] || 0));
                                    F.call($(d), w[C], C, x)
                                }
                            }
                ...
                var ba, ca, da, ea, fa, ga, ha, ia, ja = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    ka = "",
                    la = "",
                    ma = "";
                ...
                if ("horizontal" === d.p.viewsortcols[1] ? (la = " ui-i-asc", ma = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (la = " ui-single-sort-asc", ma = " ui-single-sort-desc", ka = " style='display:none'", d.p.viewsortcols[0] = !1), ba = r ? "class='ui-th-div-ie'" : "", ia = "<span class='s-ico' style='display:none'>", ia += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + la + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", !0) + "'" + ka + "></span>", ia += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + ma + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", !0) + "'" + ka + "></span></span>", d.p.multiSort && d.p.sortname)
                    for (s = d.p.sortname.split(","),
                        i = 0; i < s.length; i++) u = $.trim(s[i]).split(" "), s[i] = $.trim(u[0]), t[i] = u[1] ? $.trim(u[1]) : d.p.sortorder || "asc";
                for (i = 0; i < this.p.colNames.length; i++) {
                    var na = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[i]) + '"' : "";
                    ja += "<th id='" + d.p.id + "_" + d.p.colModel[i].name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + na + ">", ca = d.p.colModel[i].index || d.p.colModel[i].name, ja += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[i].name + "' " + ba + ">" + d.p.colNames[i], d.p.colModel[i].width ? d.p.colModel[i].width = parseInt(d.p.colModel[i].width, 10) : d.p.colModel[i].width = 150, "boolean" != typeof d.p.colModel[i].title && (d.p.colModel[i].title = !0), d.p.colModel[i].lso = "", ca === d.p.sortname && (d.p.lastsort = i), d.p.multiSort && (u = $.inArray(ca, s), -1 !== u && (d.p.colModel[i].lso = t[u])), ja += ia + "</div></th>"
                }
                if (ja += "</tr></thead>", ia = null, $(this).append(ja), $("thead tr:first th", this).hover(function() {
                        $(this).addClass(o)
                    }, function() {
                        $(this).removeClass(o)
                    }), this.p.multiselect) {
                    ...
                    $("#cb_" + $.jgrid.jqID(d.p.id), this).bind("click", function() {
                        ...
                        }), oa = !0, pa = []) : ($(d.rows).each(function(b) {
                        ...
                        }), d.p.selrow = null, oa = !1), $(d).triggerHandler("jqGridSelectAll", [oa ? d.p.selarrrow : pa, oa]), $.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, oa ? d.p.selarrrow : pa, oa)
                    })
                }
                if (d.p.autowidth === !0) {
                    var qa = $(v).innerWidth();
                ...
                W(), $(v).css("width", e.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"), d.p.scrollPopUp && $(v).append("<div " + k(l, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + d.p.id + "'></div>"), $(j).css("width", e.width + "px"), ja = $("thead:first", d).get(0);
                var ra = "";
                d.p.footerrow && (ra += "<table role='presentation' style='width:" + d.p.tblwidth + "px' " + k(l, "footerTable", !1, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + k(l, "footerBox", !1, "footrow footrow-" + h) + ">");
                var sa = $("tr:first", ja),
                    ta = "<tr class='jqgfirstrow' role='row'>";
                if (d.p.disableClick = !1, $("th", sa).each(function(a) {
                        da = d.p.colModel[a].width, void 0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = !0), d.p.colModel[a].resizable ? (ea = document.createElement("span"), $(ea).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : ea = "", $(this).css("width", da + "px").prepend(ea), ea = null;
                        var b = "";
                        d.p.colModel[a].hidden && ($(this).css("display", "none"), b = "display:none;"), ta += "<td role='gridcell' style='height:0px;width:" + da + "px;" + b + "'></td>", e.headers[a] = {
                            width: da,
                            el: this
                        }, ka = d.p.colModel[a].sortable, "boolean" != typeof ka && (d.p.colModel[a].sortable = !0, ka = !0);
                        var c = d.p.colModel[a].name;
                        "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"), ka && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), d.p.colModel[a].lso && $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass(m).css("display", "")) : d.p.colModel[a].lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass(m).css("display", "")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === d.p.lastsort && $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", "")) : a === d.p.lastsort && "" !== d.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + d.p.sortorder, this).removeClass(m).css("display", ""))), d.p.footerrow && (ra += "<td role='gridcell' " + z(a, 0, "", null, "", !1) + ">&#160;</td>")
                    ...
                    $(d).jqGrid("sortableColumns", sa)
                } catch (ua) {}
                d.p.footerrow && (ra += "</tr></tbody></table>"), ta += "</tr>", ha = document.createElement("tbody"), this.appendChild(ha), $(this).addClass(k(l, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(ta), ta = null;
                var va = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ja),
                    wa = !(!d.p.caption || d.p.hiddengrid !== !0),
                    xa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>");
                ja = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(xa), $(xa).append(va), va = null, wa && $(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
                    width: e.width + "px"
                }).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(v), wa && $(d.p.pager).hide(), T(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function(a) {
                    ga = $(a.target).closest("tr.jqgrow"), "ui-subgrid" !== $(ga).attr("class") && $(ga).addClass(o)
                }).bind("mouseout", function(a) {
                    ga = $(a.target).closest("tr.jqgrow"), $(ga).removeClass(o)
                });
                var ya, za, Aa;
                $(d).before(e.hDiv).click(function(a) {
                    if (fa = a.target, ga = $(fa, d.rows).closest("tr.jqgrow"), 0 === $(ga).length || ga[0].className.indexOf(m) > -1 || ($(fa, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id) return this;
                    var b = $(fa).hasClass("cbox"),
                        c = $(d).triggerHandler("jqGridBeforeSelectRow", [ga[0].id, a]);
                    if (c = c !== !1 && "stop" !== c, $.isFunction(d.p.beforeSelectRow)) {
                        var e = d.p.beforeSelectRow.call(d, ga[0].id, a);
                        e !== !1 && "stop" !== e || (c = !1)
                    }
                    if ("A" !== fa.tagName && ("INPUT" !== fa.tagName && "TEXTAREA" !== fa.tagName && "OPTION" !== fa.tagName && "SELECT" !== fa.tagName || b))
                        if (ya = ga[0].id, fa = $(fa).closest("tr.jqgrow>td"), fa.length > 0 && (za = $.jgrid.getCellIndex(fa), Aa = $(fa).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [ya, za, Aa, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ya, za, Aa, a)), d.p.cellEdit !== !0) {
                            if (c)
                                if (d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", ya, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                                else if (d.p.multiselect && d.p.multiboxonly)
                                if (b) $(d).jqGrid("setSelection", ya, !0, a);
                                else {
                                    var f = d.p.frozenColumns ? d.p.id + "_frozen" : "";
                                    ...
                                    }), d.p.selarrrow = [], $(d).jqGrid("setSelection", ya, !0, a)
                                }
                            else $(d).jqGrid("setSelection", ya, !0, a)
                        } else if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", ya, !0, a);
                    else if (fa.length > 0) try {
                        $(d).jqGrid("editCell", ga[0].rowIndex, za, !0)
                    } catch (g) {}
                    ...
                    if (fa = a.target, ga = $(fa, d.rows).closest("tr.jqgrow"), 0 !== $(ga).length) {
                        ya = ga[0].rowIndex, za = $.jgrid.getCellIndex(fa);
                        var b = $(d).triggerHandler("jqGridDblClickRow", [$(ga).attr("id"), ya, za, a]);
                        return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(ga).attr("id"), ya, za, a), null != b) ? b : void 0
                    }
                }).bind("contextmenu", function(a) {
                    if (fa = a.target, ga = $(fa, d.rows).closest("tr.jqgrow"), 0 !== $(ga).length) {
                        d.p.multiselect || $(d).jqGrid("setSelection", ga[0].id, !0, a), ya = ga[0].rowIndex, za = $.jgrid.getCellIndex(fa);
                        var b = $(d).triggerHandler("jqGridRightClickRow", [$(ga).attr("id"), ya, za, a]);
                        return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(ga).attr("id"), ya, za, a), null != b) ? b : void 0
                    }
                ...
                var Ba = q + " " + k(l, "icon_caption_open", !0),
                    Ca = q + " " + k(l, "icon_caption_close", !0);
                e.cDiv = document.createElement("div");
                var Da = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
                    Da.addClass(o)
                }, function() {
                    Da.removeClass(o)
                }).append("<span class='ui-jqgrid-headlink " + Ba + "'></span>").css("rtl" === h ? "left" : "right", "0px") : "";
                if ($(e.cDiv).append(Da).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
                    var Ea = k(l, "customtoolbarBox", !0, "ui-userdata");
                    e.uDiv = document.createElement("div"), "top" === d.p.toolbar[1] ? $(e.uDiv).insertBefore(e.hDiv) : "bottom" === d.p.toolbar[1] && $(e.uDiv).insertAfter(e.hDiv), "both" === d.p.toolbar[1] ? (e.ubDiv = document.createElement("div"), $(e.uDiv).addClass(Ea + " ui-userdata-top").attr("id", "t_" + this.id).insertBefore(e.hDiv).width(e.width), $(e.ubDiv).addClass(Ea + " ui-userdata-bottom").attr("id", "tb_" + this.id).insertAfter(e.hDiv).width(e.width), wa && $(e.ubDiv).hide()) : $(e.uDiv).width(e.width).addClass(Ea + " ui-userdata-top").attr("id", "t_" + this.id), wa && $(e.uDiv).hide()
                }
                if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv), T(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], xa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(xa).width(e.width).insertAfter(e.hDiv), $(xa).append(ra), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", !0, "jqgrid-rownum")), wa && $(e.sDiv).hide()), xa = null, d.p.caption) {
                    ...
                    d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                        ...
                        return d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")), f += ", #" + $(e.uDiv).attr("id")), b = $(f, "#gview_" + $.jgrid.jqID(d.p.id)).length, "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function() {
                            b--, 0 === b && ($("span", g).removeClass(Ba).addClass(Ca), d.p.gridstate = "hidden", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).hide(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (wa || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function() {
                            b--, 0 === b && ($("span", g).removeClass(Ca).addClass(Ba), wa && (d.p.datatype = Fa, R(), wa = !1), d.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (wa || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }), !1
                    }), wa && (d.p.datatype = "local", $(".ui-jqgrid-titlebar-close", e.cDiv).trigger("click")))
                ...
                if ($(e.hDiv).after(e.bDiv).mousemove(function(a) {
                    ...
                    var Ga = "onorientationchange" in window,
                        Ha = Ga ? "orientationchange" : "resize";
                    $(window).on(Ha, function() {
                        $(d).jqGrid("resizeGrid")
                    })
                }
            }
        ...
        addRowData: function(a, b, c, d) {
            ...
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function() {
                ...
                var y, z = 0,
                    ...
                    B = {},
                    C = !!$.isFunction(w.p.afterInsertRow);
            ...
            return this.each(function() {
                ...
                if (b.grid) {
                    ...
                    b.p.footerrow && a && $(".ui-jqgrid-ftable td", b.grid.sDiv).html("&#160;"),
                        b.p.selrow = null, b.p.selarrrow = [], b.p.savedRow = [], b.p.records = 0, b.p.page = 1, b.p.lastpage = 0, b.p.reccount = 0, b.p.data = [], b.p._index = {}, b.updatepager(!0, !1)
                }
            })
        },
        getInd: function(a, b) {
                        ...
                        switch (j.edittype) {
                            case "select":
                                if (j.editoptions.multiple) {
                                    var n = $("#" + a + "_" + l, d.rows[a]),
                                        o = [];
                                    g = $(n).val(), g ? g.join(",") : g = "", $("option:selected", n).each(function(a, b) {
                                        o[a] = $(b).text()
                                    }), h = o.join(",")
                            ...
                            case "checkbox":
                                var p = ["Yes", "No"];
                                j.editoptions && (p = j.editoptions.value.split(":")), g = $("#" + a + "_" + l, d.rows[a]).is(":checked") ? p[0] : p[1], h = g;
                                break;
                            case "password":
                            case "text":
                            case "textarea":
                            ...
                            case "custom":
                                try {
                                    ...
                                    "e1" === q ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.nodefined, f.bClose, {
                                        styleUI: d.p.styleUI
                                    }) : "e2" === q ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.novalue, f.bClose, {
                                        styleUI: d.p.styleUI
                                    }) : $.jgrid.info_dialog(e.errcap, q.message, f.bClose, {
                                        styleUI: d.p.styleUI
                                    })
                                }
                        }
                        if (h !== d.p.savedRow[c].v) {
                            var r = $(d).triggerHandler("jqGridBeforeSaveCell", [d.rows[a].id, k, g, a, b]);
                            if (r && (g = r, h = r), $.isFunction(d.p.beforeSaveCell)) {
                                var s = d.p.beforeSaveCell.call(d, d.rows[a].id, k, g, a, b);
                                s && (g = s, h = s)
                            }
                            var t = $.jgrid.checkValues.call(d, g, b),
                                u = !1;
                            if (t[0] === !0) {
                                var v = $(d).triggerHandler("jqGridBeforeSubmitCell", [d.rows[a].id, k, g, a, b]) || {};
                                if ($.isFunction(d.p.beforeSubmitCell) && (v = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), v || (v = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit)
                                    if (d.p.cellurl) {
                                        var w = {};
                                        d.p.autoencode && (g = $.jgrid.htmlEncode(g)), j.editoptions && j.editoptions.NullIfEmpty && "" === g && (g = "null", u = !0), w[k] = g;
                                        var x, y, z;
                                        z = d.p.prmNames, x = z.id, y = z.oper, w[x] = $.jgrid.stripPref(d.p.idPrefix, d.rows[a].id), w[y] = z.editoper, w = $.extend(v, w), $(d).jqGrid("progressBar", {
                                            method: "show",
                                            loadtype: d.p.loadui,
                                            htmlcontent: $.jgrid.getRegional(d, "defaults.savetext")
                                        }), d.grid.hDiv.loading = !0, $.ajax($.extend({
                                            url: d.p.cellurl,
                                            data: $.isFunction(d.p.serializeCellData) ? d.p.serializeCellData.call(d, w, k) : w,
                                            type: "POST",
                                            complete: function(c, j) {
                                                if ($(d).jqGrid("progressBar", {
                                                    ...
                                                    var l = $(d).triggerHandler("jqGridAfterSubmitCell", [d, c, w.id, k, g, a, b]) || [!0, ""];
                                                    l[0] === !0 && $.isFunction(d.p.afterSubmitCell) && (l = d.p.afterSubmitCell.call(d, c, w.id, k, g, a, b)), l[0] === !0 ? (u && (g = ""), $(i).empty(), $(d).jqGrid("setCell", d.rows[a].id, b, h, !1, !1, !0), $(i).addClass("dirty-cell"), $(d.rows[a]).addClass("edited"), $(d).triggerHandler("jqGridAfterSaveCell", [d.rows[a].id, k, g, a, b]), $.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.rows[a].id, k, g, a, b), d.p.savedRow.splice(0, 1)) : ($.jgrid.info_dialog(e.errcap, l[1], f.bClose, {
                                                        styleUI: d.p.styleUI
                                                    }), d.p.restoreCellonFail && $(d).jqGrid("restoreCell", a, b))
                                                }
                                            },
                                            error: function(c, g, h) {
                                                $("#lui_" + $.jgrid.jqID(d.p.id)).hide(), d.grid.hDiv.loading = !1, $(d).triggerHandler("jqGridErrorCell", [c, g, h]), $.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, c, g, h) : $.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, {
                                                    styleUI: d.p.styleUI
                                                }), d.p.restoreCellonFail && $(d).jqGrid("restoreCell", a, b)
                                            }
        ...
        createModal: function(a, b, c, d, e, f, g) {
            ...
            if ($("a.ui-jqdialog-titlebar-close", m).click(function() {
                ...
                r ? c.zIndex = parseInt(r, 10) + 2 : c.zIndex = 950
            }
            var s = 0;
            if (i && p.left && !f && (s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8, p.left = parseInt(p.left, 10) + parseInt(s, 10)), p.left && (p.left += "px"), $(l).css($.extend({
                ...
                if ($(m).css("cursor", "move"), $.fn.tinyDraggable) $(l).tinyDraggable({
        ...
        viewModal: function(a, b) {
            if (b = $.extend({
                    ...
                    jqm: !0,
                    jqM: !0
                }, b || {}), void 0 === b.focusField && (b.focusField = 0), "number" == typeof b.focusField && b.focusField >= 0 ? b.focusField = parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? b.focusField = 0 : b.focusField = !1, $.fn.jqm && b.jqm === !0) b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow();
        ...
        checkDate: function(a, b) {
            ...
            return -1 === h ? !1 : (l = e[a[h]].toString(), 2 === f && 1 === l.length && (f = 1), l.length !== f || 0 === e[a[h]] && "00" !== b[h] ? !1 : -1 === j ? !1 : (l = e[a[j]].toString(), l.length < 1 || e[a[j]] < 1 || e[a[j]] > 12 ? !1 : -1 === i ? !1 : (l = e[a[i]].toString(), !(l.length < 1 || e[a[i]] < 1 || e[a[i]] > 31 || 2 === e[a[j]] && e[a[i]] > d(e[a[h]]) || e[a[i]] > m[e[a[j]]]))))
        },
        isEmpty: function(a) {
            return !(!a.match(/^\s+$/) && "" !== a)
        },
            ...
            return a = $.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e, f, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                        ...
                        i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base,
                        j = function() {
                            var b, d, e, f = {},
                                g = 0,
                                h = {};
                            ...
                            var m = "stop" === $(c).triggerHandler("jqGridToolbarBeforeSearch");
                        ...
                        m = function(b, d, e) {
                            ...
                            for (var f, i, k = $(".ui-jqgrid-view").css("font-size") || "11px", l = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + k + ";left:" + d + "px;top:" + e + 'px;">', m = $(b).attr("soper"), n = [], o = 0, p = $(b).attr("colname"), q = c.p.colModel.length; q > o && c.p.colModel[o].name !== p;) o++;
                            ...
                            for (s.sopt || (s.sopt = [], s.sopt[0] = "select" === r.stype ? "eq" : a.defaultSearch), $.each(a.odata, function() {
                                    n.push(this.oper)
                                }), o = 0; o < s.sopt.length; o++) i = $.inArray(s.sopt[o], n), -1 !== i && (f = m === a.odata[i].oper ? h.highlight : "", l += '<li class="ui-menu-item ' + f + '" role="presentation"><a class="' + h.cornerall + ' g-menu-item" tabindex="0" role="menuitem" value="' + a.odata[i].oper + '" oper="' + a.operands[a.odata[i].oper] + '"><table class="ui-common-table"><tr><td width="25px">' + a.operands[a.odata[i].oper] + "</td><td>" + a.odata[i].text + "</td></tr></table></a></li>");
                    ...
                    a.restoreFromFilters && (f = c.p.postData.filters, f && ("string" == typeof f && (f = $.jgrid.parse(f)), e = f.rules.length ? f.rules : !1)), $.each(c.p.colModel, function(b) {
                        var f, h, k, l, m, o, p, q, r = this,
                            s = "",
                            t = "=",
                        ...
                        if (this.hidden === !0 && $(u).css("display", "none"), this.search = this.search !== !1, void 0 === this.stype && (this.stype = "text"), f = $.extend({}, this.searchoptions || {}, {
                                name: r.index || r.name,
                            ...
                            if (a.searchOperators) {
                                for (h = f.sopt ? f.sopt[0] : "select" === r.stype ? "eq" : a.defaultSearch, a.restoreFromFilters && q && (h = q.op), k = 0; k < a.odata.length; k++)
                                    if (a.odata[k].oper === h) {
                                        t = a.operands[h] || "";
                                        break
                                    }
                                l = null != f.searchtitle ? f.searchtitle : a.operandTitle, s = "<a title='" + l + "' style='padding-right: 0.5em;' soper='" + h + "' class='soptclass' colname='" + this.name + "'>" + t + "</a>"
                            }
                            switch ($("td:eq(0)", w).attr("colindex", b).append(s), void 0 === f.clearSearch && (f.clearSearch = !0), f.clearSearch ? (m = a.resetTitle || "Clear Search Value", $("td:eq(2)", w).append("<a title='" + m + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + a.resetIcon + "</a>")) : $("td:eq(2)", w).hide(), this.surl && (f.dataUrl = this.surl), o = "", f.defaultValue && (o = $.isFunction(f.defaultValue) ? f.defaultValue.call(c) : f.defaultValue), a.restoreFromFilters && q && (o = q.data), p = $.jgrid.createEl.call(c, this.stype, f, o, !1, $.extend({}, $.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {})), $(p).addClass(g.srInput), $("td:eq(1)", w).append(p), $(v).append(w), null == f.dataEvents && (f.dataEvents = []), this.stype) {
                                case "select":
                                    a.autosearch === !0 && f.dataEvents.push({
                                        type: "change",
                                        fn: function() {
                                            return j(), !1
                                        }
                                    ...
                                    break;
                                case "text":
                                    a.autosearch === !0 && (a.searchOnEnter ? f.dataEvents.push({
                                        type: "keypress",
                                        fn: function(a) {
                                            var b = a.charCode || a.keyCode || 0;
                                            return 13 === b ? (j(), !1) : this
                                        }
                                    }) : f.dataEvents.push({
                                        type: "keydown",
                                        fn: function(b) {
                        ...
                        $(u).append(v), $(n).append(u), a.searchOperators || $("td:eq(0)", w).hide()
                        ...
                        "select" === c.p.colModel[d].stype ? f ? $("td.ui-search-input select", b).val(f) : $("td.ui-search-input select", b)[0].selectedIndex = 0 : $("td.ui-search-input input", b).val(f), a.autosearch === !0 && j()
                ...
                return b = $.extend(!0, {
                        ...
                        $(y).find(".FormElement").each(function() {
                            ...
                            if (a.length) {
                                ...
                                switch ($(this).get(0).type) {
                                    case "checkbox":
                                        if ($(this).is(":checked")) s[this.name] = $(this).val();
                                        else {
                                        ...
                                        break;
                                    case "select-one":
                                        s[this.name] = $("option:selected", this).val();
                                        break;
                                    case "select-multiple":
                                        s[this.name] = $(this).val(), s[this.name] ? s[this.name] = s[this.name].join(",") : s[this.name] = "";
                                        var f = [];
                    ...
                    function d(a, b, c, d) {
                        var f, g, h, i, j, k, l, m = 0,
                            n = [],
                            o = !1,
                            p = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>",
                            r = "";
                        for (l = 1; d >= l; l++) r += p;
                        if ("_empty" !== a && (o = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function(l) {
                                if (f = this.name, g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && this.editable === !0 && "rn" !== f) {
                                    if (o === !1) i = "";
                    ...
                    function g(a, b, c) {
                        var d, e, f, g, h, i, j = 0;
                        (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData = {}, rp_ge[q.p.id]._savedData[b.p.id + "_id"] = a);
                        var k = b.p.colModel;
                        if ("_empty" === a) return $(k).each(function() {
                            d = this.name, g = $.extend({}, this.editoptions || {}), f = $("#" + $.jgrid.jqID(d), c), f && f.length && null !== f[0] && (h = "", "custom" === this.edittype && $.isFunction(g.custom_value) ? g.custom_value.call(q, $("#" + d, c), "set", h) : g.defaultValue ? (h = $.isFunction(g.defaultValue) ? g.defaultValue.call(q) : g.defaultValue, "checkbox" === f[0].type ? (i = h.toLowerCase(), i.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== i ? (f[0].checked = !0, f[0].defaultChecked = !0, f[0].value = h) : (f[0].checked = !1, f[0].defaultChecked = !1)) : f.val(h)) : "checkbox" === f[0].type ? (f[0].checked = !1, f[0].defaultChecked = !1, h = $(f).attr("offval")) : f[0].type && "select" === f[0].type.substr(0, 6) ? f[0].selectedIndex = 0 : f.val(h), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[d] = h))
                        }), void $("#id_g", c).val(a);
                        ...
                        l && ($('td[role="gridcell"]', l).each(function(f) {
                            if (d = k[f].name, "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0) {
                                ...
                                switch (q.p.autoencode && (e = $.jgrid.htmlDecode(e)), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[d] = e), d = $.jgrid.jqID(d), k[f].edittype) {
                                    case "password":
                                    case "text":
                                    case "button":
                                    case "image":
                                    ...
                                    case "select":
                                        ...
                                        h = $.map(h, function(a) {
                                            ...
                                            k[f].editoptions.multiple || $.trim(e) !== $.trim($(this).text()) && h[0] !== $.trim($(this).text()) && h[0] !== $.trim($(this).val()) ? k[f].editoptions.multiple && ($.inArray($.trim($(this).text()), h) > -1 || $.inArray($.trim($(this).val()), h) > -1) ? this.selected = !0 : this.selected = !1 : this.selected = !0
                                        }), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (e = $("#" + d, c).val(), k[f].editoptions.multiple && (e = e.join(",")), rp_ge[q.p.id]._savedData[d] = e);
                                        break;
                                    case "checkbox":
                                        if (e = String(e), k[f].editoptions && k[f].editoptions.value) {
                                            var i = k[f].editoptions.value.split(":");
                                            i[0] === e ? $("#" + d, c)[q.p.useProp ? "prop" : "attr"]({
                                                checked: !0,
                                                defaultChecked: !0
                                        ...
                                        (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (e = $("#" + d, c).is(":checked") ? $("#" + d, c).val() : $("#" + d, c).attr("offval"), rp_ge[q.p.id]._savedData[d] = e);
                                        break;
                                    case "custom":
                                        try {
                                            ...
                                            "e1" === l ? $.jgrid.info_dialog(E.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.nodefined, $.rp_ge[$(this)[0]].p.bClose, {
                                                styleUI: rp_ge[$(this)[0]].p.styleUI
                                            }) : $.jgrid.info_dialog(E.errcap, l.message, $.rp_ge[$(this)[0]].p.bClose, {
                                                styleUI: rp_ge[$(this)[0]].p.styleUI
                                            })
                                        }
                                }
                        ...
                        }), j > 0 && ($("#id_g", y).val(a), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[b.p.id + "_id"] = a)))
                    }

                    function h() {
                        $.each(q.p.colModel, function(a, b) {
                            b.editoptions && b.editoptions.NullIfEmpty === !0 && s.hasOwnProperty(b.name) && "" === s[b.name] && (s[b.name] = "null")
                        })
                    }
                    ...
                    function i() {
                        var a, c, d, e, i, j, k, l = [!0, "", ""],
                            m = {},
                            n = q.p.prmNames,
                            o = $(q).triggerHandler("jqGridAddEditBeforeCheckValues", [$(w), u]);
                        o && "object" == typeof o && (s = o), $.isFunction(rp_ge[q.p.id].beforeCheckValues) && (o = rp_ge[q.p.id].beforeCheckValues.call(q, s, $(w), u), o && "object" == typeof o && (s = o));
                        for (e in s)
                            if (s.hasOwnProperty(e) && (l = $.jgrid.checkValues.call(q, s[e], e), l[0] === !1)) break;
                        if (h(), l[0] && (m = $(q).triggerHandler("jqGridAddEditClickSubmit", [rp_ge[q.p.id], s, u]), void 0 === m && $.isFunction(rp_ge[q.p.id].onclickSubmit) && (m = rp_ge[q.p.id].onclickSubmit.call(q, rp_ge[q.p.id], s, u) || {}), l = $(q).triggerHandler("jqGridAddEditBeforeSubmit", [s, $(w), u]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[q.p.id].beforeSubmit) && (l = rp_ge[q.p.id].beforeSubmit.call(q, s, $(w), u))), l[0] && !rp_ge[q.p.id].processing) {
                            ...
                            var t = $.extend({
                                ...
                                complete: function(e, h) {
                                    ...
                                    if ($("#sData", y + "_2").removeClass(f.active), s[c] = q.p.idPrefix + s[c], e.status >= 300 && 304 !== e.status ? (l[0] = !1, l[1] = $(q).triggerHandler("jqGridAddEditErrorTextFormat", [e, u]), $.isFunction(rp_ge[q.p.id].errorTextFormat) ? l[1] = rp_ge[q.p.id].errorTextFormat.call(q, e, u) : l[1] = h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(q).triggerHandler("jqGridAddEditAfterSubmit", [e, s, u]), void 0 === l && (l = [!0, "", ""]), l[0] && $.isFunction(rp_ge[q.p.id].afterSubmit) && (l = rp_ge[q.p.id].afterSubmit.call(q, e, s, u))), l[0] === !1) $(".FormError", w).html(l[1]), $(".FormError", w).show();
                                        ...
                                        }, 1e3)) : q.p.treeGrid === !0 ? $(q).jqGrid("setTreeRow", s[c], s) : $(q).jqGrid("setRowData", s[c], s), rp_ge[q.p.id].closeAfterEdit && $.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                                            gb: "#gbox_" + $.jgrid.jqID(v),
                                            jqm: b.jqModal,
                                            onClose: rp_ge[q.p.id].onClose,
                                            removemodal: rp_ge[q.p.id].removemodal,
                                            formprop: !rp_ge[q.p.id].recreateForm,
                                            form: rp_ge[q.p.id].form
                                        })), $.isFunction(rp_ge[q.p.id].afterComplete) && (a = e, setTimeout(function() {
                                            $(q).triggerHandler("jqGridAddEditAfterComplete", [a, s, $(w), u]), rp_ge[q.p.id].afterComplete.call(q, a, s, $(w), u), a = null
                                        }, 500)), (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && ($(w).data("disabled", !1), "_empty" !== rp_ge[q.p.id]._savedData[q.p.id + "_id"]))
                                        for (j in rp_ge[q.p.id]._savedData) rp_ge[q.p.id]._savedData.hasOwnProperty(j) && s[j] && (rp_ge[q.p.id]._savedData[j] = s[j]);
                            ...
                            if (t.url || rp_ge[q.p.id].useDataProxy || ($.isFunction(q.p.dataProxy) ? rp_ge[q.p.id].useDataProxy = !0 : (l[0] = !1, l[1] += " " + E.nourl)), l[0])
                                if (rp_ge[q.p.id].useDataProxy) {
                                    var x = q.p.dataProxy.call(q, t, "set_" + q.p.id);
                                    void 0 === x && (x = [!0, ""]), x[0] === !1 ? (l[0] = !1, l[1] = x[1] || "Error deleting the selected row!") : (t.data.oper === n.addoper && rp_ge[q.p.id].closeAfterAdd && $.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                                        gb: "#gbox_" + $.jgrid.jqID(v),
                                        jqm: b.jqModal,
                                        onClose: rp_ge[q.p.id].onClose,
                                        removemodal: rp_ge[q.p.id].removemodal,
                        ...
                        l[0] === !1 && ($(".FormError", w).html(l[1]), $(".FormError", w).show())
                    }
                    ...
                    function k() {
                        var a = !0;
                        return $(".FormError", w).hide(), rp_ge[q.p.id].checkOnUpdate && (s = {}, c(), t = j(s, rp_ge[q.p.id]._savedData), t && ($(w).data("disabled", !0), $(".confirm", "#" + z.themodal).show(), a = !1)), a
                    }
                    ...
                    function p() {
                        if (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) {
                            var a = [],
                                b = {};
                            a = $.map(rp_ge[q.p.id]._savedData, function(a, b) {
                                return b
                            }), $(".FormElement", J).each(function() {
                                if (-1 === a.indexOf(this.name)) {
                                    var c = $(this).val(),
                                        d = $(this).get(0).type;
                                    if ("checkbox" === d) $(this).is(":checked") || (c = $(this).attr("offval"));
                                    else if ("select-multiple" === d) c = c.join(",");
                                    else if ("radio" === d) {
                                        if (b.hasOwnProperty(this.name)) return !0;
                                        b[this.name] = void 0 === $(this).attr("offval") ? "off" : $(this).attr("offval")
                                    }
                                    rp_ge[q.p.id]._savedData[this.name] = c
                                }
                            });
                            for (var c in b)
                                if (b.hasOwnProperty(c)) {
                                    var d = $('input[name="' + c + '"]:checked', J).val();
                                    rp_ge[q.p.id]._savedData[c] = void 0 !== d ? d : b[c]
                                }
                        }
                    }
                    var q = this;
                    if (q.grid && a) {
                        var r, s, t, u, v = q.p.id,
                            w = "FrmGrid_" + v,
                            x = "TblGrid_" + v,
                            y = "#" + $.jgrid.jqID(x),
                            z = {
                        ...
                        var G, H = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px",
                        ...
                        if (D ? (G = o(rp_ge[$(this)[0].p.id].template), r = y) : (G = $("<table id='" + x + "' class='EditTable ui-common-table'><tbody></tbody></table>"), r = y + "_2"), w = "#" + $.jgrid.jqID(w), $(J).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(J).append("<div class='tinfo topinfo'>" + rp_ge[q.p.id].topinfo + "</div>"), $(q.p.colModel).each(function() {
                            ...
                            }), $(J).append(G), A = $(q).triggerHandler("jqGridAddEditBeforeInitData", [J, u]), void 0 === A && (A = !0), A && $.isFunction(rp_ge[q.p.id].beforeInitData) && (A = rp_ge[q.p.id].beforeInitData.call(q, J, u)), A !== !1) {
                            l(), d(a, q, G, B);
                            var K = "rtl" === q.p.direction,
                                ...
                                R = "<table style='height:auto' class='EditTable ui-common-table' id='" + x + "_2'><tbody><tr><td colspan='2'><hr class='" + f.content + "' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (K ? O + N : N + O) + "</td><td class='EditButton'>" + P + Q + "</td></tr>";
                            if (R += "</tbody></table>", C > 0) {
                                var S = [];
                            ...
                            var T = !1;
                            b.closeOnEscape === !0 && (b.closeOnEscape = !1, T = !0);
                            var U;
                            if (D ? ($(J).find("#pData").replaceWith(N), $(J).find("#nData").replaceWith(O), $(J).find("#sData").replaceWith(P), $(J).find("#cData").replaceWith(Q), U = $("<div id=" + x + "></div>").append(J)) : U = $("<div></div>").append(J).append(R), $(J).append("<div class='binfo topinfo bottominfo'>" + rp_ge[q.p.id].bottominfo + "</div>"), $.jgrid.createModal(z, U, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(q.p.id), $("#gbox_" + $.jgrid.jqID(q.p.id))[0]), K && ($("#pData, #nData", y + "_2").css("float", "right"), $(".EditButton", y + "_2").css("text-align", "left")), rp_ge[q.p.id].topinfo && $(".tinfo", w).show(), rp_ge[q.p.id].bottominfo && $(".binfo", w).show(), U = null, R = null, $("#" + $.jgrid.jqID(z.themodal)).keydown(function(a) {
                                    var c = a.target;
                                    if ($(w).data("disabled") === !0) return !1;
                                    if (rp_ge[q.p.id].savekey[0] === !0 && a.which === rp_ge[q.p.id].savekey[1] && "TEXTAREA" !== c.tagName) return $("#sData", y + "_2").trigger("click"), !1;
                                    if (27 === a.which) return k() ? (T && $.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                                        gb: b.gbox,
                                        jqm: b.jqModal,
                                        onClose: rp_ge[q.p.id].onClose,
                                        removemodal: rp_ge[q.p.id].removemodal,
                                ...
                                }), b.checkOnUpdate && ($("a.ui-jqdialog-titlebar-close span", "#" + $.jgrid.jqID(z.themodal)).removeClass("jqmClose"), $("a.ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(z.themodal)).unbind("click").click(function() {
                                ...
                                var V = b.zIndex || 999;
                                V++, $("<div class='" + b.overlayClass + " jqgrid-overlay confirm' style='z-index:" + V + ";display:none;'>&#160;</div><div class='confirm ui-jqconfirm " + f.content + "' style='z-index:" + (V + 1) + "'>" + b.saveData + "<br/><br/>" + P + O + Q + "</div>").insertAfter(w), $("#sNew", "#" + $.jgrid.jqID(z.themodal)).click(function() {
                            ...
                            $(q).triggerHandler("jqGridAddEditInitializeForm", [$(w), u]), $.isFunction(rp_ge[q.p.id].onInitializeForm) && rp_ge[q.p.id].onInitializeForm.call(q, $(w), u), "_empty" !== a && rp_ge[q.p.id].viewPagerButtons ? $("#pData,#nData", r).show() : $("#pData,#nData", r).hide(), $(q).triggerHandler("jqGridAddEditBeforeShowForm", [$(w), u]), $.isFunction(rp_ge[q.p.id].beforeShowForm) && rp_ge[q.p.id].beforeShowForm.call(q, $(w), u), p(), $("#" + $.jgrid.jqID(z.themodal)).data("onClose", rp_ge[q.p.id].onClose), $.jgrid.viewModal("#" + $.jgrid.jqID(z.themodal), {
                                ...
                                return s = {}, $(".FormError", w).hide(), c(), "_empty" === s[q.p.id + "_id"] ? i() : b.checkOnSubmit === !0 ? (t = j(s, rp_ge[q.p.id]._savedData), t ? ($(w).data("disabled", !0), $(".confirm", "#" + $.jgrid.jqID(z.themodal)).show()) : i()) : i(), !1
                                ...
                                if (a[0] = parseInt(a[0], 10), -1 !== a[0] && a[1][a[0] + 1]) {
                                    ...
                                    var c;
                                    if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(q, "next", $(w), a[1][a[0]]), void 0 !== c && c === !1)) return !1;
                                    if ($("#" + $.jgrid.jqID(a[1][a[0] + 1])).hasClass(f.disabled)) return !1;
                                    g(a[1][a[0] + 1], q, w), $(q).jqGrid("setSelection", a[1][a[0] + 1]), $(q).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", $(w), a[1][a[0]]]), $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(q, "next", $(w), a[1][a[0] + 1]), p(), m(a[0] + 1, a)
                                }
                                return !1
                                ...
                                if (-1 !== a[0] && a[1][a[0] - 1]) {
                                    ...
                                    var c;
                                    if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(q, "prev", $(w), a[1][a[0]]), void 0 !== c && c === !1)) return !1;
                                    if ($("#" + $.jgrid.jqID(a[1][a[0] - 1])).hasClass(f.disabled)) return !1;
                                    g(a[1][a[0] - 1], q, w), $(q).jqGrid("setSelection", a[1][a[0] - 1]), $(q).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", $(w), a[1][a[0]]]), $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(q, "prev", $(w), a[1][a[0] - 1]), p(), m(a[0] - 1, a)
                                }
                                return !1
                ...
                return b = $.extend(!0, {
                    ...
                    function d(a, c, d, e) {
                        ...
                        if ($(c.p.colModel).each(function() {
                                h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0, h || "right" !== this.align || (this.formatter && -1 !== $.inArray(this.formatter, v) ? w = Math.max(w, parseInt(this.width, 10)) : x = Math.max(x, parseInt(this.width, 10)))
                            }), m = 0 !== w ? w : 0 !== x ? x : 0, r = $(c).jqGrid("getInd", a), $(c.p.colModel).each(function(a) {
                                if (g = this.name, n = !1, h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0, k = h ? "style='display:none'" : "", o = "boolean" != typeof this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                                    j = r === !1 ? "" : g === c.p.ExpandColumn && c.p.treeGrid === !0 ? $("td:eq(" + a + ")", c.rows[r]).text() : $("td:eq(" + a + ")", c.rows[r]).html(), n = "right" === this.align && 0 !== m;
                                    var b = $.extend({}, {
                                            rowabove: !1,
                                            rowcontent: ""
                                        }, this.formoptions || {}),
                    ...
                    function g(a, b) {
                        ...
                        f = $(b).jqGrid("getInd", a, !0), f && ($("td", f).each(function(a) {
                            c = b.p.colModel[a].name, d = b.p.colModel[a].editrules && b.p.colModel[a].editrules.edithidden === !0 ? !1 : b.p.colModel[a].hidden === !0, "cb" !== c && "subgrid" !== c && "rn" !== c && (e = c === b.p.ExpandColumn && b.p.treeGrid === !0 ? $(this).text() : $(this).html(), c = $.jgrid.jqID("v_" + c), $("#" + c + " span", "#" + m).html(e), d && $("#" + c, "#" + m).parents("tr:first").hide(), g++)
                        }), g > 0 && $("#id_g", "#" + m).val(a))
                    }
                                ...
                                if (n = {}, $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}), $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)), e[0] && !rp_ge[c.p.id].processing) {
                                    ...
                                    var k = $.extend({
                                        ...
                                        complete: function(a, g) {
                                            var h;
                                            if ($("#dData", "#" + p + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = !1, $.isFunction(rp_ge[c.p.id].errorTextFormat) ? e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a) : e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)), e[0] === !1) $("#DelError>td", "#" + p).html(e[1]), $("#DelError", "#" + p).show();
                                            else {
            ...
            _buildNavMenu: function(a, b, c, d, e, f, g, h) {
                return this.each(function() {
                    var i = this,
                        ...
                        k = i.p.styleUI,
                        l = ($.jgrid.styleUI[k].navigator, $.jgrid.styleUI[k].filter),
                    ...
                    var q = {
                        ...
                        r = function() {
                            var a, j, k = $(".ui-jqgrid-view").css("font-size") || "11px",
                            ...
                            }), $(o).append(j), g.showOnLoad && g.showOnLoad === !0 && $(j).click()), c.refresh && (a = g.id || "search_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.refreshtext || c.refreshtitle) + "</a></li>").click(function() {
                                if (!$(this).hasClass(m.disabled)) {
                    ...
                    r(), $(".dropdownmenu", a + "_" + c.position).on("click", function(a) {
                        var b = $(this).offset(),
                            c = b.left,
                            d = parseInt(b.top),
                            e = $(this).val();
                ...
                if (c = $.extend({
                    ...
                    if (b) {
                        ...
                        if (d = jqGridUtils.parse(b), d && "object" === $.type(d)) {
                            i.grid && $.jgrid.gridUnload(a), $.isFunction(c.beforeSetGrid) && (e = c.beforeSetGrid(d), e && "object" === $.type(e) && (d = e));
                            var k = function(a) {
                                    var b;
                                    return b = a
                                },
                            ...
                            d.shrinkToFit = !1, d.data = [], d.datatype = "local", d.grouping = !1, d.inlineNav && (g = k(d._iN), d._iN = null, delete d._iN), d.filterToolbar && (h = k(d._fT), d._fT = null, delete d._fT);
                            var m = $("#" + a).jqGrid(d);
                            if (m.append(f), m.jqGrid("setGridParam", l), d.storeNavOptions && d.navGrid && (m[0].p.navGrid = !1, m.jqGrid("navGrid", d.pager, d.navOptions, d.editOptions, d.addOptions, d.delOptions, d.searchOptions, d.viewOptions), d.navButtons && d.navButtons.length))
                                for (var n = 0; n < d.navButtons.length; n++) "sepclass" in d.navButtons[n][1] ? m.jqGrid("navSeparatorAdd", d.navButtons[n][0], d.navButtons[n][1]) : m.jqGrid("navButtonAdd", d.navButtons[n][0], d.navButtons[n][1]);
                            d.inlineNav && g && (m.jqGrid("setGridParam", {
                                inlineNav: !1
                            }), m.jqGrid("inlineNav", d.pager, g)), d.filterToolbar && h && (m.jqGrid("setGridParam", {
                                filterToolbar: !1
                            }), h.restoreFromFilters = !0, m.jqGrid("filterToolbar", h)), d.frozenColumns && m.jqGrid("setFrozenColumns"), m[0].updatepager(!0, !0), $.isFunction(c.afterSetGrid) && c.afterSetGrid(m), c.clearAfterLoad && (window[c.storageType].removeItem("jqGrid" + i.id), window[c.storageType].removeItem("jqGrid" + i.id + "_data"))
            ...
            editRow: function(a, b, c, d, e, f, g, h, i) {
                ...
                return "object" === $.type(k[0]) ? j = k[0] : (void 0 !== b && (j.keys = b), $.isFunction(c) && (j.oneditfunc = c), $.isFunction(d) && (j.successfunc = d), void 0 !== e && (j.url = e), void 0 !== f && (j.extraparam = f), $.isFunction(g) && (j.aftersavefunc = g), $.isFunction(h) && (j.errorfunc = h), $.isFunction(i) && (j.afterrestorefunc = i)), j = $.extend(!0, {
                    ...
                    h.grid && (e = $(h).jqGrid("getInd", a, !0), e !== !1 && (g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0, void 0 === g && (g = !0), g && (d = $(e).attr("editable") || "0", "0" !== d || $(e).hasClass("not-editable-row") || (f = h.p.colModel, $('td[role="gridcell"]', e).each(function(d) {
                        ...
                        a.length > 0 && a.focus()
                    }, 0)), j.keys === !0 && $(e).bind(j.keyevent, function(b) {
                        if (27 === b.keyCode) {
    ...
    $.jgrid.extend({
                                ...
                                return $.extend({
                                    accept: function(a) {
                                        ...
                                        if (b.length > 0 && void 0 !== $.data(b[0], "dnd")) {
                                            ...
                                            return -1 !== $.inArray("#" + $.jgrid.jqID(this.id), c)
                                        }
                                        return !1
                                    },
                                    drop: function(b, c) {
            ...
            return this.each(function() {
                ...
                function m(a, b, c, d) {
                    var e, h, i, j, k = b.length,
                        m = "",
                        n = [];
                    for ($.isArray(c) ? (j = c.length, n = c) : (j = 1, n[0] = c), f = [], g = [], f.root = 0, d._count ? d._count++ : d._count = 1, i = 0; j > i; i++) {
                        var o, p = [];
                        for (e = 0; k > e; e++) {
                            ...
                            h = isNaN(parseInt(h, 10)) ? h : h + " ", d[h] = p[h] = l(b[e].aggregator, d[h], b[e].member, a, d._count)
                        }
                        m += c[i].replace(/\s+/g, ""), f[h] = p, g[h] = n[i]
                    }
                    return d
                }
                    ...
                    for (e in a)
                        if (a.hasOwnProperty(e)) {
                            if ("object" != typeof a[e]) {
                                if ("level" === e) {
                                    if (void 0 === J[a.level] && (J[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (i[a.level - 1] = {
                                            useColSpanStyle: !1,
                                            groupHeaders: []
                                        })), J[a.level] !== a.text && a.children.length && -1 === a.text.indexOf("_r_Totals") && a.level > 0) {
                            ...
                            if (null != a[e] && "object" == typeof a[e] && n(a[e]), "level" === e && a.level > 0 && (a.level === (0 === s ? a.level : s) || -1 !== J[a.level].indexOf("_r_Totals"))) {
                                d = 0;
                                for (b in a.fields)
        ...
        jqPivot: function(a, b, c, d) {
            return this.each(function() {
                function e(a) {
                    var d, e, g, h, i = jQuery(f).jqGrid("pivotSetup", a, b),
                        j = $.assocArraySize(i.summary) > 0,
                    ...
                    h = b.xDimension.length, i.groupOptions.sortname && h && (e = b.xDimension[h - 1].sortorder ? b.xDimension[h - 1].sortorder : "asc", g = b.xDimension[h - 1].sorttype ? b.xDimension[h - 1].sorttype : "text", k.orderBy(i.groupOptions.sortname, e, g, "", g)), jQuery(f).jqGrid($.extend(!0, {
                    ...
                    if (l.length)
                        for (d = 0; d < l.length; d++) l[d] && l[d].groupHeaders.length && jQuery(f).jqGrid("setGroupHeaders", l[d]);
                ...
                if (c.grid) {
                    ...
                    for (void 0 !== b && b > 0 && (q = b, p = b + 1); p > q;) $(c.rows[q]).hasClass("jqgrow") && (c.p.scroll && $(c.rows[q].cells[a]).unbind("click"), $(c.rows[q].cells[a]).bind("click", function() {
                        ...
                        if (e = c.p.id, d = b.id, h = $("#" + e + "_" + d + "_expandedContent"), $(this).hasClass("sgcollapsed")) {
                            if (g = $(c).triggerHandler("jqGridSubGridBeforeExpand", [e + "_" + d, d]), g = g !== !1 && "stop" !== g, g && $.isFunction(c.p.subGridBeforeExpand) && (g = c.p.subGridBeforeExpand.call(c, e + "_" + d, d)), g === !1) return !1;
                            ...
                            if (g = $(c).triggerHandler("jqGridSubGridRowColapsed", [e + "_" + d, d]), g = g !== !1 && "stop" !== g, g && $.isFunction(c.p.subGridRowColapsed) && (g = c.p.subGridRowColapsed.call(c, e + "_" + d, d)), g === !1) return !1;
        ...
        isNodeLoaded: function(a) {
            ...
            return this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    b = void 0 !== a ? void 0 !== a[e] ? a[e] : !!(a[d] || $(c).jqGrid("getNodeChildren", a).length > 0) : !1
                }
            }), b
        },
    ...
    $.fmatter = {}, $.extend($.fmatter, {
        ...
        if (void 0 !== b.colModel.formatoptions ? (e = b.colModel.formatoptions.value, c = void 0 === b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter) : void 0 !== b.colModel.editoptions && (e = b.colModel.editoptions.value, c = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, d = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter), e) {
            var g, h = (null != b.colModel.editoptions && b.colModel.editoptions.multiple === !0) == !0,
                i = [];
