...
! function(a) {
    ...
    f.Client.prototype = {
        ...
        glue: function(a, b) {
            ...
            g.position = "absolute", g.left = "0px", g.top = "0px", g.width = e.width + "px", g.height = e.height + "px", g.zIndex = d, "undefined" != typeof b && "" !== b && (this.div.title = b), 0 !== e.width && 0 !== e.height && (this.sized = !0), this.domElement && (this.domElement.appendChild(this.div), this.div.innerHTML = this.getHTML(e.width, e.height).replace(/&/g, "&amp;"))
        },
        ...
        destroy: function() {
            var b = this;
            this.domElement && this.div && (a(this.div).remove(), this.domElement = null, this.div = null, a.each(f.clients, function(a, c) {
        ...
        setSheetName: function(a) {
            this.sheetName = a, this.ready && this.movie.setSheetName(a)
        },
    ...
    var g = function(a, b) {
        ...
        m = function(a, b) {
            for (var c = l(b), e = a.buttons.exportData(b.exportOptions), f = b.fieldBoundary, g = b.fieldSeparator, h = new RegExp(f, "g"), i = b.escapeChar !== d ? b.escapeChar : "\\", j = function(a) {
                    ...
                    return b
                }, k = b.header ? j(e.header) + c : "", m = b.footer && e.footer ? c + j(e.footer) : "", n = [], o = 0, p = e.body.length; p > o; o++) n.push(j(e.body[o]));
            return {
                str: k + n.join(c) + m,
                rows: n.length
            }
        ...
        n = {
            ...
            init: function(a, b, c) {
                ...
                var d = new f.Client;
                d.setHandCursor(!0), d.addEventListener("mouseDown", function(d) {
    ...
    return e.Buttons.swfPath = "assets/swf/flashExport.swf", e.Api.register("buttons.resize()", function() {
        ...
        action: function(a, b, c, d) {
            if (d._fromFlash) {
                ...
                e.setAction("copy"), k(e, g), b.buttons.info(b.i18n("buttons.copyTitle", "Copy to clipboard"), b.i18n("buttons.copyInfo", {
        ...
        action: function(a, b, c, d) {
            var e = d._flash,
                f = m(b, d),
                g = d.customize ? d.customize(f.str, d) : f.str;
            e.setAction("csv"), e.setFileName(h(d)), k(e, g)
        },
        escapeChar: '"'
        ...
        action: function(b, c, e, f) {
            var g = "",
                ...
                m = function(b) {
                    for (var c = [], e = 0, f = b.length; f > e; e++) null !== b[e] && b[e] !== d || (b[e] = ""), c.push("number" == typeof b[e] || b[e].match && a.trim(b[e]).match(/^-?\d+(\.\d+)?$/) && "0" !== b[e].charAt(0) ? '<c t="n"><v>' + b[e] + "</v></c>" : '<c t="inlineStr"><is><t>' + (b[e].replace ? b[e].replace(/&(?!amp;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\x00-\x1F\x7F-\x9F]/g, "") : b[e]) + "</t></is></c>");
                    return "<row>" + c.join("") + "</row>"
                };
            f.header && (g += m(l.header));
            for (var n = 0, o = l.body.length; o > n; n++) g += m(l.body[n]);
            f.footer && (g += m(l.footer)), j.setAction("excel"), j.setFileName(h(f)), j.setSheetName(i(f)), k(j, g)
        },
        extension: ".xlsx"
        ...
        action: function(a, b, c, d) {
            ...
            e.setAction("pdf"), e.setFileName(j(d)), k(e, JSON.stringify({
                title: h(d, !1),
                message: d.message,
                colWidth: i.toArray(),
