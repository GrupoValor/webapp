    ...
    b.prototype = {
        ...
        show: function() {
            ...
            b.element.parent().prepend(b.element.detach().hide()), b.element.wrap(a('<div class="tags">')).parent().on("click", function() {
                ...
                if (188 == c.keyCode || 13 == c.keyCode || 9 == c.keyCode) !a.trim(a(this).val()) || b.element.siblings(".typeahead").length && !b.element.siblings(".typeahead").is(":hidden") ? 188 == c.keyCode && (b.options.autocompleteOnComma ? !b.element.siblings(".typeahead").length || b.element.siblings(".typeahead").is(":hidden") ? c.preventDefault() : (b.input.data("bs_typeahead").select(), c.stopPropagation(), c.preventDefault()) : (c.preventDefault(), b.process())) : (9 != c.keyCode && c.preventDefault(), b.process());
